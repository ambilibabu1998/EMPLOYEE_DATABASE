    ...
    <div className="sidebar">
      <div className="sidebarWrapper">
        ...
        <div className="sidebarMenu">
          ...
          <p className="emil">Email: employee.detils.com</p>
          <p className="emil">Ph. No.: 080-10-297297, +91 80 26721983, +91 80 26722108 </p>
          <p className="emil"> 100 Feet Ring Road, BSK III Stage, Bangalore-560085</p>
        </div>
      </div>
    </div>
  );
